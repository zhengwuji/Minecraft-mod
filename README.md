...
- **2026-07-22**:
  - 升级 **【精妙背包 (`Sophisticated Backpacks`)】**：已为**【生存模式无限升级 (`survival_infinibag_upgrade`)】**与**【无限升级 (管理员) (`infinibag_upgrade`)】**添加了专属生存模式合成表（使用升级基质、钻石、金锭与绿宝石合成），并支持在工作台中无缝互相转换！
  - 升级 **【随身食物BUFF背包 (`FoodBuffBag`)】**：正式突破仅限食物的限制，全面支持将**任意附魔装备/武器/防具/饰品/药水物品**直接放入仓库，且支持**全量同类附魔与 BUFF 无上限等级累加叠加机制**！
